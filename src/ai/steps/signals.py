...
from src.ai.prompts import PROMPT_DETECT_CONTEXT as _PROMPT_DETECT_CONTEXT
from src.ai.prompts import PROMPT_DETECT_SKILLS as _PROMPT_DETECT_SKILLS
...
def _llm_detect_signals(
    *,
    ...
    shared_sections = dict(
        ...
        theme_names="",  # unused by v2 prompts; required by v1 for A/B eval
    )
